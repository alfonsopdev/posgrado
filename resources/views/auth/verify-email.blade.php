    ...
    <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
                    <!--begin::Header-->
                            <div id="kt_app_header" class="app-header">
                                ...
                                <div id="app" class="app-container container-fluid d-flex align-items-stretch justify-content-between">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <div class="menu-content d-flex align-items-center px-3">
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <div class="fw-bold d-flex align-items-center fs-5">{{ Auth::User()->nombre}}</div>
                                                    ...
                                                    <div class="menu-item px-5">
                                                        <form id="my_form" action="{{route('logout')}}" method="POST">
                                                            ...
                                                            <a href="javascript:{}" onclick="document.getElementById('my_form').submit();" class="menu-link px-5">Sign Out</a>
                                                            {{-- <input type="submit" class="menu-link px-5" value="Sign Out" /> --}}
                                                        </form>
                            ...
                            <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
                                ...
                                <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                                    ...
                                    <div class="menu-item" v-if="is('Postulante')">
                                        <!--begin:Menu link-->
                                        <a class="menu-link active" to="/email/verify" exact-active-class="active">
                                            ...
                                            <span class="menu-title">Verificar email</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                    ...
                    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                                    ...
                                    <div class="d-flex flex-column flex-center text-center">
                                        ...
                                        <div class="card card-flush w-lg-650px py-5">
                                            <div class="card-body py-5 py-lg-10">
                                                ...
                                                <div class="mb-7">
                                                    <a href="#" class="">
                                                        <img alt="Logo" src="../assets/media/logos/icono.png" class="h-100px">
                                                    </a>
                                                </div>
                                                {{-- <div class="mb-14">
                                                    <a href="#" class="">
                                                ...
                                                <!--end::Logo-->
                                                <!--begin::Title-->
                                                <h1 class="fw-bolder text-gray-900 mb-5">Verifique su correo electrónico</h1>
                                                <!--end::Title-->
                                                <!--begin::Action-->
                                                <div class="fs-6 mb-8">
                                                    @if (session('status') == 'verification-link-sent')
                                                        <div class="alert alert-success text-center">¡Se le ha enviado un nuevo enlace de verificación de correo electrónico!</div>
                                                    @endif
                                                        {{-- <a href="/metronic8/demo1/../demo1/authentication/layouts/corporate/sign-up.html" class="link-primary fw-bold">Enviar otra vez</a> --}}
                                                    <form id="my_form2" method="POST" action="{{ route('verification.send') }}" class="text-center">
                                                        <span class="fw-semibold text-gray-500">¿No recibiste un correo electrónico?</span>
                                                        @csrf
                                                        <a href="javascript:{}" onclick="document.getElementById('my_form2').submit();" class="link-primary fw-bold">Enviar otra vez</a>
                                                    </form>
                                                </div>
                                                <!--end::Action-->
                                                <!--begin::Link-->
                                                {{-- <div class="mb-11">
                                                    <a href="/metronic8/demo1/../demo1/index.html" class="btn btn-sm btn-primary">Skip for now</a>
                                                </div> --}}
                                                <!--end::Link-->
                                                <!--begin::Illustration-->
                                                <div class="mb-0">
                        ...
                        >
                          ...
                          <div class="text-dark order-2 order-md-1">
                            ...
                            <a
                              href="https://posgrado.undc.edu.pe/"
                              target="_blank"
                          ...
                          <ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
                            ...
                            <li class="menu-item">
                              <a
                                href="https://www.facebook.com/preundc"
                                target="_blank"
                                class="menu-link px-2"
                                >CEPRE</a
                              >
