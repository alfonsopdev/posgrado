    ...
    <div class="card mb-5 mb-xl-8">
		...
		<div class="card-header border-0 pt-5">
			<h3 class="card-title align-items-start flex-column">
				...
				<span class="text-muted mt-1 fw-semibold fs-7">Valida los pagos por concepto de recargo extemporaneo</span>
			</h3>
		</div>
		<!--end::Header-->
		<!--begin::Body-->
                        ...
                        <tbody>
                            ...
                            <tr v-else v-for="(dato, index) in datos" :index="index" :key="dato.id"> 
                                ...
                                <td>
                                    ...
                                    <span v-if="dato.id_tipo_pago==4">RECARGO S/50</span>
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    <div v-if="dato.id_estado_revision==1">
                                        <form @submit.prevent="verificar(2,dato.id, dato.observacion, dato.codigo_pago)">
                                            <div>
                                                <!-- <select class="form-control m-input m-input--square" v-model="dato.observacion" required>
                                                    <option value=null>Seccione una opción</option>
...
export default {
    ...
    methods: {
        async mostrarDatos() {
			...
			await axios
				.get(this.$parent.NombreRuta + "/api/pagos/vouchers?tipo=4&estado="+estado)
				.then((response) => {
