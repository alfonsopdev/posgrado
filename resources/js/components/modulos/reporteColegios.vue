    ...
    <div>
        <div class="card mb-5 mb-xl-8">
            <div class="card-header border-0 pt-5">
                ...
                <span class="card-label fw-bold fs-3 mb-1">Reporte por Universidades</span>
                </h3>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-row-bordered">
                        ...
                        <tr v-else v-for="(dato, index) in data" :index="index" :key="index">
                            ...
                            <td class="text-center">{{ dato.departamento }}</td>
                            <td class="ps-4"> {{ dato.provincia }}</td>
                        ...
                        <tfoot>
                            <tr class="fw-bold bg-light">
                                <td colspan="4" class="text-center">TOTAL GENERAL:</td>
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">            
                <span class="card-label fw-bold text-dark">Reporte por Universidades</span>
            </h3>
        </div>
        <div class="card-body">
            <div id="kt_apexcharts_1" style="height: 900px;"></div>
        </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        async mostrarDatos() {
            ...
            await axios
                .get(this.$parent.NombreRuta + "/api/reporte/colegios?id_provincia="+provincia+"&carrera="+carrera+"&modalidad="+modalidad)
                .then((response) => {
                this.data = response.data.colegios;
                this.chart.updateSeries([{
                    data: response.data.colegios
                }])
