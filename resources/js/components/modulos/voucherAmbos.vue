                ...
                <table class="table align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            ...
                            <tr v-else v-for="(dato, index) in datos" :index="index" :key="dato.id"> 
                                ...
                                <td class="text-center">
                                    <!-- <button type="button" @click.prevent="ver(dato.id)" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_1">
                                        Launch demo modal
                                    </button> -->
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title">REVISAR VOUCHER</h3>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <h3>DATOS DE PAGO</h3>
                                    <div class="row">
                                        <div class=" col-md-12">asda</div>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <h3>VISTA DE COMPROBANTE</h3>
                                    <div id="previewImg" class="previewImg">
                                      <img :src="$parent.NombreRuta + '/storage/pagos/76218845-03-0201.jpg'" id="zoomImg" class="img-fluid" alt="Eniun">  
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    mounted() {
        ...
        previewImg.addEventListener("mousemove", function(event){
            let clientX = event.clientX - previewImg.offsetLeft
            let clientY = event.clientY - previewImg.offsetTop
            var mWidth = previewImg.offsetWidth
            var mHeight = previewImg.offsetHeight
            console.log('event.clientX : ' + event.clientX )
            console.log('previewImg.offsetLeft: ' + previewImg.offsetLeft)
            ...
            /* zoomImg.style.transformOrigin = `${clientX}px ${clientY}px`
            zoomImg.style.transform = 'scale(2)' */
            
            /* console.log(previewImg+': '+clientX+','+clientY)
            console.log('translate(-'+clientX+'%, -'+clientY+ '%) scale(2)')*/
            zoomImg.style.transform = 'translate('+clientX+'%, '+clientY+ '%) scale(2)' 
            //zoomImg.style.transform = 'translate('+clientX+'%, '+clientY+ '%) scale(2)'
        })
        zoomImg.addEventListener("mouseleave", function (event) {
